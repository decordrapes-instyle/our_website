...
const Profile: React.FC = () => {
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      const unsubscribe = onValue(quotationsRef, (snapshot) => {
        ...
        if (data) {
          const userQuotations = Object.values(data).filter(
            (quotation: any) =>
              quotation.customer &&
              quotation.customer.email === currentUser.email
          ) as Quotation[];
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-neutral-950">
      <ProfileHeader />
      <div className="relative px-4 bg-gray-100 dark:bg-neutral-950">
        <button
          onClick={() => navigate("/")}
              ...
              <div className="mt-4 sm:mt-0 self-center sm:self-start">
                {!isEditing ? (
                  <button
                    ...
                    className="bg-neutral-200 dark:bg-neutral-700 hover:bg-neutral-300 dark:hover:bg-neutral-600 text-neutral-800 dark:text-neutral-200 py-2 px-4 rounded-full flex items-center gap-2 text-sm font-medium"
                  >
                  ...
                  <div className="flex space-x-2">
                    <button
                      ...
                      disabled={loading}
                      className="bg-neutral-800 dark:bg-neutral-200 text-white dark:text-black px-4 py-2 rounded-full hover:bg-neutral-900 dark:hover:bg-white disabled:opacity-50 flex items-center gap-2 font-medium"
                    >
                      {loading ? (
                        "Saving..."
                      ) : (
                    ...
                    <button
                      ...
                      className="bg-neutral-200 dark:bg-neutral-700 text-neutral-800 dark:text-neutral-200 px-4 py-2 rounded-full hover:bg-neutral-300 dark:hover:bg-neutral-600 flex items-center gap-2 font-medium"
                    >
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg">
            ...
            <div className="p-4 sm:p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <Input
                          ...
                          onChange={(v) =>
                            setFormData({ ...formData, displayName: v })
                          }
                        />
                        <Input
                          label="Phone"
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full border border-gray-300 dark:border-neutral-600 bg-transparent dark:text-neutral-100 px-3 py-2 mt-1 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              ...
              {activeTab === "quotations" && (
                <QuotationsDashboard quotations={quotations} />
              )}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between bg-gray-50 dark:bg-neutral-700/50 p-4 rounded-xl">
                      ...
                      <button
                        ...
                        className="bg-neutral-200 dark:bg-neutral-600 text-neutral-800 dark:text-neutral-200 py-2 px-4 rounded-full text-sm font-medium flex-shrink-0"
                      >
                        Send Email
                      </button>
                    </div>
                    <div className="flex items-center justify-between bg-red-100/50 dark:bg-red-900/20 p-4 rounded-xl">
                      ...
                      <button
                        onClick={logout}
                        className="bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded-full text-sm font-medium"
                      >
                        Logout
                      </button>
                    </div>
...
const TabButton = ({
  ...
  <button
    ...
    className={`flex items-center gap-2 py-3 px-4 text-sm font-medium border-b-2 transition-colors ${
      active
        ? "border-neutral-500 text-neutral-800 dark:text-neutral-100"
        : "border-transparent text-gray-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200 hover:border-gray-300"
    }`}
  >
...
const Info = ({
  ...
  <div className="flex items-start gap-4 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-700/50">
    ...
    <div>
      ...
      <p
        className={`text-base font-medium text-gray-800 dark:text-neutral-200 ${
