...
import {
  User, Mail, Calendar, Camera, Edit, Save, X, Phone,
  MapPin, Briefcase, CheckCircle, Settings, FileText
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-neutral-950 py-10 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-neutral-800 p-4 sm:p-6 rounded-2xl shadow-lg mb-6">
                    ...
                    <h2 className="text-xl font-semibold text-gray-800 dark:text-neutral-100 mb-4">Account Settings</h2>
                     <div className="space-y-4">
                        <div className="flex items-center justify-between bg-gray-50 dark:bg-neutral-700/50 p-4 rounded-xl">
                           ...
                           <button onClick={handleResetPassword} className="bg-neutral-200 dark:bg-neutral-600 text-neutral-800 dark:text-neutral-200 py-2 px-4 rounded-full text-sm font-medium">
                             Send Email
                           </button>
                        </div>
